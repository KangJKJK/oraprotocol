...
echo
read -p "EVM프라이빗 키를 입력하세요(노드전용 버너지갑): " PRIV_KEY
read -p "Ethereum 메인넷의 Alchemy WSS URL을 입력하세요: " MAINNET_WSS
read -p "Ethereum 메인넷의 Alchemy HTTP URL을 입력하세요: " MAINNET_HTTP
read -p "Sepolia Ethereum의 Alchemy WSS URL을 입력하세요: " SEPOLIA_WSS
read -p "Sepolia Ethereum의 Alchemy HTTP URL을 입력하세요: " SEPOLIA_HTTP
